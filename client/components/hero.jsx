  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white via-white/90 to-white/50">
          Master Your <br />
          Career Journey
        </h1>
